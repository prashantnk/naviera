...
import { getSupabaseClient } from "@/lib/supabase"; // 🔥 Imported Supabase
import {
  ArrowLeft,
  ArrowRight,
  Box,
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      {shipment.tracking_id && (
        <div className="bg-primary rounded-2xl shadow-lg p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left relative z-10">
            ...
            <div>
              ...
              <p className="text-white/80 mt-1">
                View the public tracking page for real-time updates and
                shareable links.
              </p>
            </div>
          </div>
          ...
          <Button
            ...
            size="lg"
            asChild
            className="w-full sm:w-auto font-bold shadow-sm relative z-10 h-12 px-8 hover:scale-105 transition-transform duration-200"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* ➡️ RIGHT SIDEBAR: Packages & Documents */}
        <div className="space-y-6">
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex flex-col lg:max-h-[500px]">
          ...
          {shipment.documents && shipment.documents.length > 0 && (
            <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
              <div className="p-4 border-b border-slate-100 bg-slate-50 flex items-center gap-2">
                ...
                <h3 className="font-semibold text-slate-900">
                  Secure Documents ({shipment.documents.length})
                </h3>
              </div>
