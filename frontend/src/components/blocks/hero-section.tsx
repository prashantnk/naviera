...
function BrandLogo({ name }: { name: string }) {
  ...
  if (n === "DHL")
    return (
      <div className="bg-[#FFCC00] px-3 py-1 rounded text-[#D40511] font-black italic text-xl tracking-tighter shadow-sm">
        DHL
      </div>
    );
  if (n === "FEDEX")
  ...
  if (n === "DTDC")
    return (
      <div className="text-2xl font-black italic text-[#003366] tracking-tighter">
        DTDC
      </div>
    );
  if (n === "BLUE DART")
    return (
      <div className="text-xl font-black text-[#0055A5] tracking-tighter uppercase">
        BLUE DART
      </div>
    );
  if (n === "UPS")
    return (
      <div className="text-2xl font-bold text-[#351C15] tracking-tighter">
        ups
      </div>
    );
  ...
  return (
    <div className="text-xl font-bold text-slate-700 tracking-tight uppercase bg-white px-3 py-1 rounded shadow-sm border border-slate-100">
      {name}
    </div>
  );
}
            ...
            <div className="lg:col-span-6 flex flex-col justify-center space-y-8 relative z-20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2 animate-in fade-in duration-700 delay-300">
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="h-16 px-8 rounded-xl text-lg font-bold shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 text-slate-700 bg-white border-2 border-slate-200 hover:bg-slate-50 hover:border-slate-300"
                >
